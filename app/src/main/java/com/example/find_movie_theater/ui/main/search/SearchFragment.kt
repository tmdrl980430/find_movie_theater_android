...
class SearchFragment(): BaseFragment<FragmentSearchBinding>(FragmentSearchBinding::inflate) {
    var movieList = arrayListOf(Movie(1, "actor1", "dddd",123), Movie(2, "actor2", "ddd",null), Movie(3, "actor3", "dddd",null), Movie(3, "actor3", "dddd",null), Movie(3, "actor3", "dddd",null), Movie(3, "actor3", "dddd",null), Movie(3, "actor3", "dddd",null), Movie(3, "actor3", "dddd",null), Movie(3, "actor3", "dddd",null), Movie(3, "actor3", "dddd",null))
